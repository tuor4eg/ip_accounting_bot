...
func NewRunner(tg *telegram.Client) *Runner {
	tgRunner := &Runner{
		tg:  tg,
...
// SetBotDeps injects bot dependencies into the Runner and returns the runner for chaining.
func (r *Runner) SetBotDeps(deps *bot.BotDeps) *Runner {
	r.botDeps = deps
